...
[![Laravel](https://img.shields.io/badge/Laravel-v13.0-FF2D20?style=flat&logo=laravel&logoColor=white)](https://laravel.com)
...
- **Modern Stack**: Built with Laravel 13 (PHP 8.3+), Livewire 3, Volt, and Tailwind CSS 4
...
- PHP 8.3 or higher (Laravel 13 requirement)
- Composer
- Node.js and NPM
